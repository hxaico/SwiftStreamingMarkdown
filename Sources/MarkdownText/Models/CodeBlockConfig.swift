...
public struct CodeBlockConfig: Hashable, Sendable {
  ...
  /// Corner radius of the code block. `nil` falls back to the default corner radius of 20.
  public let cornerRadius: CGFloat?

  /// Font set used for the code text. `nil` falls back to the default code font set.
  public let textFonts: TextFonts?

  /// Foreground color applied to the code text. `nil` falls back to the syntax highlighting theme colors.
  ...
  ///   - cornerRadius: See `cornerRadius`. Defaults to `nil`.
  ///   - textFonts: See `textFonts`. Defaults to `nil`.
  ///   - textColor: See `textColor`. Defaults to `nil`.
  public init(
    theme: Theme = .default,
    backgroundColor: Color? = nil,
    foregroundColor: Color? = nil,
    cornerRadius: CGFloat? = nil,
    textFonts: TextFonts? = nil,
    textColor: Color? = nil
  ) {
    self.theme = theme
